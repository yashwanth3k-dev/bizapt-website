  ...
  return (
    <div style={{ background: "var(--bg)" }}>
      ...
      <article className="px-5 pb-12 sm:px-8">
        <div className="mx-auto max-w-2xl space-y-5 text-base leading-relaxed" style={{ color: "var(--fg-muted)" }}>
        ...
        <div className="mx-auto mt-12 flex max-w-2xl flex-wrap gap-3 border-t pt-10" style={{ borderColor: "var(--line)" }}>
